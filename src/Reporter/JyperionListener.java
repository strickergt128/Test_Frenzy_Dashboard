...
public class JyperionListener implements ITestListener {
	...
	public void onFinish(ITestContext context) {
        // Creating a simple pie chart with 
         ...
         try {
            ChartUtilities.saveChartAsJPEG(new File("C:\\Users\\Dilan\\eclipse-workspace\\FrenzyDashboard\\simplePiechart.jpg"), piechart, 525, 390);
        } catch (IOException e) {
         ...
         try {
			...
			img = Image.getInstance("C:\\Users\\Dilan\\eclipse-workspace\\FrenzyDashboard\\simplePiechart.jpg");
